    ...
    notification: [
      {
        ...
        message:
          "Hello there, check tahis new items in from the your may interested from the motion school",
        time: "10 minutes ago",
      },
      {
        image: "https://readymadeui.com/profile_2.webp",
...
function renderNotification(notification: NotificationItem[]) {
  return (
    <ScrollArea className="h-72 w-80">
          ...
          <div key={index}>
            <li className="py-2 px-4 flex items-start hover:bg-gray-50 text-black text-sm cursor-pointer">
              ...
              <div className="ml-6">
                ...
                <p className="text-xs text-cyan-600 leading-3 mt-2">
                  {item.time}
                </p>
              </div>
            </li>
      ...
      <p className="w-full text-center text-xs text-gray-500 py-3 px-4 inline-block">
      ...
      return (
        <div key={index}>
          ...
          <MenubarSub>
            ...
            <MenubarSubContent>{renderSubMenu(item.subMenu)}</MenubarSubContent>
          </MenubarSub>
